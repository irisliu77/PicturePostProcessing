...
public class ImageAdjuster {
	public static void main(String[] args) throws IOException {
		...
		ImageAdjusterView view = new ImageAdjusterView(picture);
		ImageAdjusterModel model =  new ImageAdjusterModel(picture);
		ImageAdjusterController adjuster_controller = new ImageAdjusterController(model, view);
